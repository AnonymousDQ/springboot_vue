...
权限管理系统是前后端分离开发的，前端使用Vue全家桶，组件库采用[Ant-Design-Vue](https://vuecomponent.github.io/ant-design-vue/docs/vue/introduce-cn/)
...
1. IDEA 或者 Eclipse需要安装lombok插件

2. 新建MySQL数据库，导入[SQL](https://github.com/wuyouzhuguli/FEBS-Vue/blob/master/sql/febs.sql)文件
